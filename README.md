...
# Instructions to run the application from Mustak
...
- Add new products and see the list of products afterwards
- The product list shows products added in database,
